package com.thalossphere.spring.cloud.service.consumer.example.controller;
...
import com.thalossphere.spring.cloud.service.api.SpringCloudBApi;
...
import com.thalossphere.spring.cloud.service.consumer.example.mapper.UserMapper;
...
//        log.info("接收到请求参数 str={}", str);
        ...
        return "[App=SpringCloudProviderA1 Tag=" + TagManager.getTag() + "] -> " + springCloudBApi.repeat(str);
    }
