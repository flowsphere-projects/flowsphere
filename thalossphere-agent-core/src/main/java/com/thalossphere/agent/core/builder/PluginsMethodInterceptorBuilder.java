...
import com.thalossphere.agent.core.config.MethodMatcherConfig;
import com.thalossphere.agent.core.interceptor.MethodInterceptor;
import com.thalossphere.agent.core.interceptor.MethodInterceptorManager;
import com.thalossphere.agent.core.interceptor.template.ConstructorMethodInterceptorTemplate;
import com.thalossphere.agent.core.interceptor.template.InstantMethodInterceptorTemplate;
import com.thalossphere.agent.core.interceptor.template.StaticMethodInterceptorTemplate;
import com.thalossphere.agent.core.utils.MethodTypeUtils;
...
public class PluginsMethodInterceptorBuilder implements InterceptorBuilder {
    ...
    public DynamicType.Builder<?> intercept(DynamicType.Builder<?> builder) {
        ...
        try {
            ...
            log.error("[thalossphere] init interceptor error", e);
        }
        return builder;
    }
